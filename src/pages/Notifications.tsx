    ...
    <div>
      <header className="sticky top-0 z-30 surface hairline-b safe-top">
        <div className="flex items-center gap-2 px-2 h-14 max-w-md mx-auto">
          ...
          <h1 className="font-medium text-base">Notifikácie</h1>
        </div>
      </header>
      ...
      <div className="max-w-md mx-auto">
        {items.length === 0 && (
          <div className="text-center py-20 px-6">
            <Bell className="w-10 h-10 mx-auto mb-4 text-muted-foreground" strokeWidth={1.5} />
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                <span className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-foreground flex items-center justify-center">
                  <Icon className="w-3 h-3 text-background" fill={n.type === "like" ? "currentColor" : "none"} strokeWidth={2} />
                </span>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm">
                  <span className="font-medium">{n.actor?.username ?? "niekto"}</span>{" "}
